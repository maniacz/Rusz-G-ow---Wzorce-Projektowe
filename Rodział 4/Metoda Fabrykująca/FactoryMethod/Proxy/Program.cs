...
namespace Proxy
{
    ...
    {
        //OLD: static void Main()
        static void Main_()
        {
            //OLD: GumMachine gumMachine = new GumMachine(5);
    ...
    public class GumMachineMonitor
    {
        GumMachine gumMachine;

        public GumMachineMonitor(GumMachine gumMachine)
        {
        ...
        public void Report()
        {
            Console.WriteLine("Automat sprzedający: " + gumMachine.GetLocalization());
            Console.WriteLine("Towar: " + gumMachine.GetGumCount() + " sz.");
            Console.WriteLine("Bieżący stan urządzenia: " + gumMachine.GetCurrentState());
        }
    }

    public class GumMachineMonitorTest
    {
        static void Main(string[] args)
        {
            ...
            if (args.Length < 2)
            {
                Console.WriteLine("Automat sprzedający <nazwa> <towar>");
                Environment.Exit(0);
            }

            count = Int32.Parse(args[1]);
            GumMachine gumMachine = new GumMachine(args[0], count);
            GumMachineMonitor monitor = new GumMachineMonitor(gumMachine);
    ...
    public class GumMachine
    {
        ...
        public GumMachine(string localization, int gumCount)
        {
